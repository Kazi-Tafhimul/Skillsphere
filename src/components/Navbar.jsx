        ...
        <div className="navbar-start">
          <div className="dropdown">
            ...
            <ul
              ...
              {session && <li><Link href="/my-profile " className={pathName === "/my-profile" ? "active text-primary font-bold text-blue-400 underline" : ""}>My Profile</Link></li>}
            </ul>
          </div>
  ...
  <div className="ring-primary ring-offset-base-100 w-12 rounded-full ring-2 ring-offset-2">
    ...
    alt="User avatar"/>
            ...
            <ul tabIndex={0} className="menu menu-sm dropdown-content bg-base-100 rounded-box z-[1] mt-3 w-52 p-2 shadow">
              <li className="px-4 py-2 font-bold border-b text-center">{session.user.name}</li>
